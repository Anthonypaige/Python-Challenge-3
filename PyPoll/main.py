...
with open(csvpath) as csvfile:
    ...
    for row in csvreader: 
        ...
        # Use this value in our percent vote calculation in the print statements
        if row[2] == "Khan": 
            khan_votes +=1
        elif row[2] == "Correy":
            correy_votes +=1
 ...
 # To find the winner make a dictionary out of the two lists we previously created 
...
election_summary =os.path.join(".","Analysis","election_summary.txt")

with open(election_summary,"w") as file:

# Write methods to print to election_summary 
    file.write(f"election summary")
    file.write("\n")
    file.write(f"----------------------------")
    file.write("\n")
